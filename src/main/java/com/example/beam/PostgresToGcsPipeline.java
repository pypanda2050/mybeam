...
public class PostgresToGcsPipeline {
    ...
    public static void main(String[] args) {
        ...
        PCollection<KV<String, String>> rows = p.apply("ReadFromPostgres", JdbcIO.<KV<String, String>>read()
                ...
                .withQuery("SELECT saga_id, node_id, create_ts, dlq_ts FROM dlq_job WHERE dlq_ts >= ?")
                .withStatementPreparator(preparedStatement -> preparedStatement.setLong(1, oneHourAgo))
                ...
                .withCoder(org.apache.beam.sdk.coders.KvCoder.of(StringUtf8Coder.of(), StringUtf8Coder.of())));

        rows.apply("WriteToGCS", FileIO.<String, KV<String, String>>writeDynamic()
                .by(KV::getKey)
