...
public class GcsProcessingPipeline {
    ...
    public static class OutputKeyCoder extends org.apache.beam.sdk.coders.AtomicCoder<OutputKey> {
        ...
        private static final org.apache.beam.sdk.coders.StringUtf8Coder STRING_CODER = org.apache.beam.sdk.coders.StringUtf8Coder
                .of();
    ...
    public static void main(String[] args) {
        ...
        PCollection<KV<OutputKey, String>> parsedRecords = groupedFiles.apply("ProcessGroups",
                ParDo.of(new DoFn<KV<String, Iterable<Metadata>>, KV<OutputKey, String>>() {
                    @ProcessElement
                    public void processElement(ProcessContext c) {
        ...
        // Value: sagaId, createTs
        // If all fields (nodeId, recordType, hour, sagaId, createTs) are same, the KV
        // is same.
        PCollection<KV<OutputKey, String>> uniqueRecords = parsedRecords
                .apply("Deduplicate", org.apache.beam.sdk.transforms.Distinct.create());

        // 4. Write Dynamic
        uniqueRecords.apply("WriteDynamic", FileIO.<OutputKey, KV<OutputKey, String>>writeDynamic()
                .by(KV::getKey)
