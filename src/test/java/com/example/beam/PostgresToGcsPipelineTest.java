...
public class PostgresToGcsPipelineTest {
    ...
    public void testPipeline() throws Exception {
        ...
        try (Connection conn = DriverManager.getConnection(JDBC_URL, USER, PASSWORD);
            ...
            stmt.execute(String.format("INSERT INTO dlq_job VALUES ('saga1', 'nodeA', %d, %d)", now, recentTs));

            // Old record (should be filtered out)
            stmt.execute(String.format("INSERT INTO dlq_job VALUES ('saga2', 'nodeB', %d, %d)", now, oldTs));
        }
