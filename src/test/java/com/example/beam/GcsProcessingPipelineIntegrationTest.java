...
/**
 * Integration test that runs the pipeline against a local GCS emulator. Requires a GCS emulator
 * (e.g., fake-gcs-server) running at http://localhost:4443.
 */
...
public class GcsProcessingPipelineIntegrationTest {
  ...
  public void testPipelineWithEmulator() throws Exception {
    ...
    com.google.cloud.storage.BlobId blobId =
        com.google.cloud.storage.BlobId.of(bucketName, filename);
